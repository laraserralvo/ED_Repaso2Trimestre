 ...
 *
 * @see Libro
 * @author Lara Serralvo
 * @version 4.3.2025 (la fecha del día que haga el examen)
 */
...
public class Biblioteca {
     ...
     * @return {@code true} si el libro se ha agregado correctamente 0 {@false} si el libro NO
    ...
    /**
     *
     * @param titulo es una cadena de texto con el titulo del libro
     * @return un libro
     */
